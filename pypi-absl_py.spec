...
%prep
%setup -q -n absl-py-1.1.0
cd %{_builddir}/absl-py-1.1.0
pushd ..
cp -a absl-py-1.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656353715
...
cp %{_builddir}/absl-py-1.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-absl_py/2b8b815229aa8a61e483fb4ba0588b8b6c491890
