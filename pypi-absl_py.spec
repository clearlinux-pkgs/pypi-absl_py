...
Version  : 2.2.1
Release  : 35
URL      : https://files.pythonhosted.org/packages/40/17/fa94446133df730f1a30f89ed9f3967d62ac0c0e535522ea4d46288924a5/absl_py-2.2.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/40/17/fa94446133df730f1a30f89ed9f3967d62ac0c0e535522ea4d46288924a5/absl_py-2.2.1.tar.gz
...
%prep
%setup -q -n absl_py-2.2.1
cd %{_builddir}/absl_py-2.2.1
pushd ..
cp -a absl_py-2.2.1 buildavx2
popd
pushd ..
cp -a absl_py-2.2.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743009253
