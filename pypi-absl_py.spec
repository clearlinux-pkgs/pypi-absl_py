...
Version  : 2.3.0
Release  : 37
URL      : https://files.pythonhosted.org/packages/03/15/18693af986560a5c3cc0b84a8046b536ffb2cdb536e03cce897f2759e284/absl_py-2.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/03/15/18693af986560a5c3cc0b84a8046b536ffb2cdb536e03cce897f2759e284/absl_py-2.3.0.tar.gz
...
%prep
%setup -q -n absl_py-2.3.0
cd %{_builddir}/absl_py-2.3.0
pushd ..
cp -a absl_py-2.3.0 buildavx2
popd
pushd ..
cp -a absl_py-2.3.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748354145
