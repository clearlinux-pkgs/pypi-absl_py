...
Source0  : https://files.pythonhosted.org/packages/20/5b/02495cbb35e658e8353e309a288efcb93b3ca3cbb87a47db49d6c6516961/absl-py-1.2.0.tar.gz
...
%prep
%setup -q -n absl-py-1.2.0
cd %{_builddir}/absl-py-1.2.0
pushd ..
cp -a absl-py-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658185727
...
cp %{_builddir}/absl-py-1.2.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-absl_py/2b8b815229aa8a61e483fb4ba0588b8b6c491890
