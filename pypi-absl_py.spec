...
Source0  : https://files.pythonhosted.org/packages/10/2a/c93173ffa1b39c1d0395b7e842bbdc62e556ca9d8d3b5572926f3e4ca752/absl_py-2.3.1.tar.gz
...
%prep
%setup -q -n absl_py-2.3.1
cd %{_builddir}/absl_py-2.3.1
pushd ..
cp -a absl_py-2.3.1 buildavx2
popd
pushd ..
cp -a absl_py-2.3.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751549770
